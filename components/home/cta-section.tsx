          ...
          <div className="flex flex-col justify-center gap-2 min-[400px]:flex-row">
            <div>
              <Button
                size="lg"
                variant="link"
                className="w-full bg-gradient-to-r from-slate-900 to-rose-500 text-white transition-colors duration-1000 hover:from-rose-500 hover:to-slate-900 min-[400px]:w-auto"
              >
                <Link
                  href="/sign-in"
