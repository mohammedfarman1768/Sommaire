  ...
  return (
    ...
    >
      <MotionDiv
        ...
        className="animate-gradient-x group relative cursor-default overflow-hidden rounded-full bg-gradient-to-r from-rose-200 via-rose-500 to-rose-800 p-[1px]"
      >
        <Badge
          variant="secondary"
      ...
      >
        <Button
          variant="link"
          className="mt-6 rounded-full bg-gradient-to-r from-slate-900 to-rose-500 px-8 py-6 text-base font-bold text-white shadow-lg transition-colors duration-1000 hover:bg-gradient-to-r hover:from-rose-500 hover:to-slate-900 hover:no-underline sm:px-10 sm:py-7 sm:text-lg lg:mt-16 lg:px-12 lg:py-8 lg:text-xl"
        >
